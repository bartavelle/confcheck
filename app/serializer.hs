...
ovalSources =
  [ DL "http://support.novell.com/security/oval" NoCompression "suse.linux.enterprise.server.11.xml" True,
    ...
    DL "http://www.redhat.com/security/data/oval/v2/RHEL6" BZip2 "rhel-6.oval.xml" False,
    DL "http://www.redhat.com/security/data/oval/v2/RHEL7" BZip2 "rhel-7.oval.xml" False,
    DL "http://www.redhat.com/security/data/oval/v2/RHEL8" BZip2 "rhel-8.oval.xml" False,
    DL "http://www.redhat.com/security/data/oval/v2/RHEL9" BZip2 "rhel-9.oval.xml" False,
    ...
    DL "https://www.debian.org/security/oval" BZip2 "oval-definitions-buster.xml" True,
    DL "https://www.debian.org/security/oval" BZip2 "oval-definitions-jessie.xml" True,
    DL "https://www.debian.org/security/oval" BZip2 "oval-definitions-stretch.xml" True,
    DL "https://www.debian.org/security/oval" BZip2 "oval-definitions-wheezy.xml" True,
    DL "https://www.debian.org/security/oval" BZip2 "oval-definitions-bullseye.xml" True,
    DL "https://www.debian.org/security/oval" BZip2 "oval-definitions-bookworm.xml" True,
    DL "https://security-metadata.canonical.com/oval" BZip2 "com.ubuntu.trusty.cve.oval.xml" False,
    DL "https://security-metadata.canonical.com/oval" BZip2 "com.ubuntu.bionic.cve.oval.xml" False,
    DL "https://security-metadata.canonical.com/oval" BZip2 "com.ubuntu.focal.cve.oval.xml" False,
    DL "https://security-metadata.canonical.com/oval" BZip2 "com.ubuntu.jammy.cve.oval.xml" False,
    DL "https://security-metadata.canonical.com/oval" BZip2 "com.ubuntu.xenial.cve.oval.xml" False,
  ...
  shakeArgs shakeOptions $ do
    ...
    "serialized/BulletinSearch.serialized" %> \out -> do
      ...
      case (<>) <$> l <*> lOld of
        ...
        Right kbdates ->
          let kblist = concatMap (\(KBDate d k1 k2 t) -> map (fmap (,t,d)) [k1, k2]) kbdates
              lst :: [(Int, T.Text, Day)]
