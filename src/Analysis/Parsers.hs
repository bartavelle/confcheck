...
import Analysis.Parsers.Megaparsec
...
textual = unT Textual.textual

stringLiteral :: IsString s => Parser s
stringLiteral = unT Tok.stringLiteral

symbolic :: Char -> Parser Char
symbolic = unT . Tok.symbolic

parens :: Parser a -> Parser a
parens = unT . Tok.parens . TXT

brackets :: Parser a -> Parser a
brackets = unT . Tok.brackets . TXT

braces :: Parser a -> Parser a
braces = unT . Tok.braces . TXT

parseInt :: (Num b, Read b, Integral b) => Parser b
parseInt = Text.Megaparsec.Char.Lexer.decimal

decimal :: Parser Integer
decimal = unT Tok.decimal
